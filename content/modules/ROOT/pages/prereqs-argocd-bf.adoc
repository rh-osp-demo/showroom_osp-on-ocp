...
Fork the github repo https://github.com/rh-osp-demo/showroom_osp-on-ocp-break-fix-using-gitops into your github personal space. 

In the next chapter we will refer to this repo as the variable: $YOUR_REPO_URL

Example:

Replace $YOUR_REPO_URL by 'https://github.com/$your_github_id/showroom_osp-on-ocp.git'
